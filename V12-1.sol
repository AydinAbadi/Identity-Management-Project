...
contract Voluntary_project {
    ...
    function insert_degree(bytes calldata degree_, bytes calldata description_, bytes calldata com_fileHash_ ,address[] calldata verifiers) external only_valid_client{
    ...
    function insert_license(bytes calldata license_, bytes calldata description, bytes calldata expiry_date, bytes calldata com_fileHash_, address[] calldata verifiers) external only_valid_client{
